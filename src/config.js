export default {
    defaultPath: '/signin',
    basename: '/propmeta', // only at build time to set, like /datta-able
    ...
    navBackColor: 'navbar-purple', // navbar-default, (navbar-blue, navbar-red, navbar-purple, navbar-lightblue, navbar-dark are not available in lite version)
